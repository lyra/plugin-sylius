...
class SmartformProvider extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('sogecommerce_get_smartform_config', [$this, 'getSmartformConfig'], ['is_safe' => ['html']]),
            new TwigFunction('sogecommerce_get_smartform_token', [$this, 'getSmartformToken'], ['is_safe' => ['html']]),
        ];
    }
