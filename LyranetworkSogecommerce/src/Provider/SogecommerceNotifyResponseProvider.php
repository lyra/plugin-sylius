 ...
 * Decorates the default response provider to return custom responses based on Sogecommerce payment details.
 */
final class SogecommerceNotifyResponseProvider implements NotifyResponseProviderInterface
{
    /**
     ...
     * Returns a custom response with Sogecommerce response code and message if available,
