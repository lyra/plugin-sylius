...
class Api
{
    ...
    {
        $currencies = array();
        if (! empty($whiteLabel) && class_exists('\Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel')) {
            $currencies = \Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel::getSupportedCurrencies($whiteLabel);
        } else {
            $currencies = array(
            ...
            array('INR', '356', 2), array('JPY', '392', 0), array('KHR', '116', 2), array('KRW', '410', 0),
    ...
    {
        if (! empty($whiteLabel) && class_exists('\Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel')) {
            return \Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel::getSupportedCardTypes($whiteLabel);
        }
        ...
        return array(
            ...
            'FULLCB4X' => 'Paiement en 4 fois CB', 'GIROPAY' => 'Giropay', 'GOOGLEPAY' => 'Google Pay', 'IDEAL' => 'iDEAL',
            ...
            'S-MONEY' => 'S-money', 'SAMSUNG_PAY' => 'Samsung Pay', 'SCT' => 'Virement SEPA', 'SDD' => 'Prélèvement SEPA', 'SODEXO' => 'Pass Restaurant',
            'SOFICARTE' => 'Soficarte', 'SYGMA' => 'Sygma', 'TRUFFAUT_CDX' => 'Carte Cadeau Truffaut',
    ...
    {
        if (! empty($whiteLabel) && class_exists('\Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel')) {
            return \Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel::getOnlineDocUri($whiteLabel);
        }
    ...
    public static function getWhiteLabelProperty($whiteLabel, $property)
    {
        if (! empty($whiteLabel) && class_exists('\Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel')) {
            ...
            if (method_exists('\Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel', $method)) {
                $values = \Lyranetwork\Sogecommerce\Sdk\Form\WhiteLabel::$method();
    ...
    {
        $urls = array(
            'gatewayUrl' => 'https://sogecommerce.societegenerale.eu/vads-payment/',
            'restUrl' => 'https://api-sogecommerce.societegenerale.eu/api-payment/',
            'staticUrl' => 'https://static-sogecommerce.societegenerale.eu/static/',
            'logoUrl' => 'https://sogecommerce.societegenerale.eu/static/latest/images/type-carte/'
        );
