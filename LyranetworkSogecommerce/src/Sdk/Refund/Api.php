...
class Api {
     ...
     */
    public function __construct($refundProcessor, $privateKey, $restServerUrl, $siteId, $cmsName, $backOfficeName = 'Sogecommerce')
    {
    ...
    public function refund($orderInfo, $amount, $whiteLabel = '')
    {
        ...
        // Get currency.
        $currency = SogecommerceApi::findCurrencyByAlphaCode($orderInfo->getOrderCurrencyIsoCode(), $whiteLabel);
