...
namespace Lyranetwork\Sogecommerce\Repository;
...
/**
 * Interface for Sogecommerce payment method repository operations.
...
interface PaymentMethodRepositoryInterface extends BasePaymentMethodRepositoryInterface
{
     ...
     *
     * @param string $gatewayFactoryName The gateway factory name (e.g., 'sogecommerce_sylius_payment')
