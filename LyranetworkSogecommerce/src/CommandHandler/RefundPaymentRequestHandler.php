...
namespace Lyranetwork\Sogecommerce\CommandHandler;
...
use Lyranetwork\Sogecommerce\Command\RefundPaymentRequest;
 ...
 * Executes refund operations through the Sogecommerce gateway and manages refund state transitions.
 */
#[AsMessageHandler]
final class RefundPaymentRequestHandler
{
     ...
     * @param RestHelper $restHelper Sogecommerce REST operations helper
    ...
    public function __invoke(RefundPaymentRequest $refundPaymentRequest): void
    {
        ...
        $currency = SogecommerceApi::findCurrencyByAlphaCode($payment->getCurrencyCode(), $whiteLabel);
    ...
    private function isValidRefundRequest(SyliusPaymentRequestInterface $paymentRequest): bool
    {
        ...
        if ($factoryName !== SogecommerceTools::FACTORY_NAME) {
            return false;
        }
