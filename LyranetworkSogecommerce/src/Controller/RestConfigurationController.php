...
use Lyranetwork\Sogecommerce\Form\Type\SyliusGatewayConfigurationType;
...
final class RestConfigurationController
{
    ...
    public function getWidgetToken(Request $request) : Response
    {
        ...
        $restUrl = SogecommerceApi::getWhiteLabelUrl($whiteLabel, 'restUrl') ?? SogecommerceTools::$REST_URL;
        ...
        $client = new SogecommerceRest($restUrl, $siteId, $key);
