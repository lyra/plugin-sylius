...
/**
 * Provides Twig functions for PayZen embedded form integration.
 *
 * This extension exposes functions to retrieve the embedded form configuration and token
 * required for payment page rendering using PayZen payment gateway.
 */
final class EmbeddedFormProvider extends AbstractExtension
{
     ...
     *
     * This method generates a payment form token from the PayZen API that will be used
     ...
     * the PayZen embedded form including theme, display mode, language, and API keys.
     *
     * @param string $instanceCode The payment method instance code
     *
     * @return array{
