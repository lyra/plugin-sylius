...
use Lyranetwork\Payzen\Form\Type\SyliusGatewayConfigurationType;
...
final class RestConfigurationController
{
    ...
    public function getWidgetToken(Request $request) : Response
    {
        ...
        $restUrl = PayzenApi::getWhiteLabelUrl($whiteLabel, 'restUrl') ?? PayzenTools::$REST_URL;
        ...
        $client = new PayzenRest($restUrl, $siteId, $key);
