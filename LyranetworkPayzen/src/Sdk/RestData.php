...
class RestData
{
    ...
    private function prepareRequest($order)
    {
        ...
        $payzenCurrency = PayzenApi::findCurrencyByAlphaCode($order->getCurrencyCode());
        ...
        $data = [
            ...
            // Misc data.
            'currency' => $payzenCurrency->getAlpha3(),
            'language' => $lang,
            'url_return' => $this->router->generate('payzen_return_url', [], UrlGenerator::ABSOLUTE_URL),
