...
final class Tools
{
     ...
     *
     * @param string $translationPrefix The translation key prefix (e.g., 'sylius_payzen_plugin.')
     *
     * @return array<string, string> Array of translation keys => mode values
     */
    public static function getPaymentDataEntryModeChoices(string $translationPrefix = 'sylius_payzen_plugin.'): array
    {
        $choices = [];
     ...
     */
    public static function getThemeChoices(string $translationPrefix = 'sylius_payzen_plugin.'): array
    {
        $choices = [];
