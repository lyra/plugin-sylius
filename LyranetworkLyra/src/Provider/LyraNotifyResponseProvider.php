 ...
 * Decorates the default response provider to return custom responses based on Lyra Collect payment details.
 */
final class LyraNotifyResponseProvider implements NotifyResponseProviderInterface
{
     ...
     * Returns a custom response with Lyra Collect response code and message if available,
