...
/**
 * Provider for retrieving payment information from Lyra Collect IPN (Instant Payment Notification) requests.
...
final class LyraNotifyPaymentProvider implements NotifyPaymentProviderInterface
{
     ...
     *
     * @return bool True if the payment method is a Lyra Collect gateway, false otherwise
     */
    public function supports(Request $request, PaymentMethodInterface $paymentMethod): bool
    {
        return $paymentMethod->getGatewayConfig()?->getFactoryName() === constant('Lyranetwork\Lyra\Sdk\Tools::FACTORY_NAME');
    }
}