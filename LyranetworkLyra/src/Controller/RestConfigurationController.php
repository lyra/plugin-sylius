...
use Lyranetwork\Lyra\Form\Type\SyliusGatewayConfigurationType;
...
final class RestConfigurationController
{
    ...
    public function getWidgetToken(Request $request) : Response
    {
        ...
        $restUrl = LyraApi::getWhiteLabelUrl($whiteLabel, 'restUrl') ?? LyraTools::$REST_URL;
        ...
        $client = new LyraRest($restUrl, $siteId, $key);
