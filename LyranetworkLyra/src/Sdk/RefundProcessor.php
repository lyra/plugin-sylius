...
use Lyranetwork\Lyra\Sdk\Refund\Processor;
...
/**
 * Processor for handling refund operations through the Lyra Collect gateway.
 *
...
final class RefundProcessor implements Processor
{
    ...
    private function formatErrorMessage(mixed $errorCode, string $message): string
    {
        ...
        $refundError = sprintf(
            $this->translate("sylius_lyra_plugin.refund.error.backoffice_action"),
    ...
    private function updateTransactionDetails(array &$details, array $operationResponse): void
    {
        ...
        if ($operationType === 'CREDIT') {
            ...
            $details['transactions'][$transUuid]['lyra_trans_status'] = $detailedStatus;
        }
    }
