...
class Api {
     ...
     */
    public function __construct($refundProcessor, $privateKey, $restServerUrl, $siteId, $cmsName, $backOfficeName = 'Lyra Expert')
    {
    ...
    public function refund($orderInfo, $amount, $whiteLabel = '')
    {
        ...
        // Get currency.
        $currency = LyraApi::findCurrencyByAlphaCode($orderInfo->getOrderCurrencyIsoCode(), $whiteLabel);
