...
namespace Lyranetwork\Systempay\Form\Type;
...
{
    private $PREFIX = 'sylius_systempay_plugin.';
    public static $REST_FIELDS = 'systempay_rest_api_';
    public static $ADVANCED_FIELDS = 'systempay_advanced_options_';
    public static $PAYMENT_OPTIONS = 'systempay_payment_options_';
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add(self::$REST_FIELDS . 'site_id', TextType::class, [
            'label' => $this->PREFIX . 'ui.systempay_site_id.label',
            'data' => $config[self::$REST_FIELDS . 'site_id'] ?? SystempayTools::getDefault('SITE_ID'),
            'help' => $this->PREFIX . 'ui.systempay_site_id.helptext',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'mode', ChoiceType::class, [
            'label' => $this->PREFIX . 'ui.systempay_mode.label',
            'choices' => [
                $this->PREFIX . 'config.test' => 'TEST',
                $this->PREFIX . 'config.production' => 'PRODUCTION'
            ],
            'help' => $this->PREFIX . 'ui.systempay_mode.helptext',
            'data' => $config[self::$REST_FIELDS . 'mode'] ?? 'TEST',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'rest_check_url', TextType::class, [
            'label' => $this->PREFIX . 'ui.systempay_rest_check_url.label',
            'disabled' => true,
            'help' => $this->PREFIX . 'ui.systempay_rest_check_url.helptext',
            'required' => false,
            'data' => $this->router->generate('systempay_rest_ipn', [], UrlGenerator::ABSOLUTE_URL)
        ])
        ->add(self::$REST_FIELDS . 'private_test_key', PasswordType::class, [
            'label' => $this->PREFIX . 'ui.systempay_private_test_key.label',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'private_prod_key', PasswordType::class, [
            'label' => $this->PREFIX . 'ui.systempay_private_prod_key.label',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'public_test_key', TextType::class, [
            'label' => $this->PREFIX . 'ui.systempay_public_test_key.label',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'public_prod_key', TextType::class, [
            'label' => $this->PREFIX . 'ui.systempay_public_prod_key.label',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'hmac_test_key', PasswordType::class, [
            'label' => $this->PREFIX . 'ui.systempay_hmac_test_key.label',
            'required' => false
        ])
        ->add(self::$REST_FIELDS . 'hmac_prod_key', PasswordType::class, [
            'label' => $this->PREFIX . 'ui.systempay_hmac_prod_key.label',
            'required' => false
        ])
        ->add(self::$ADVANCED_FIELDS . 'card_data_entry_mode', ChoiceType::class, [
            'label' => $this->PREFIX . 'ui.systempay_card_data_entry_mode.label',
            'choices' => [
            ...
            'help' => $this->PREFIX . 'ui.systempay_card_data_entry_mode.helptext',
        ...
        ->add(self::$ADVANCED_FIELDS . 'rest_popin_mode', CheckboxType::class, [
            'label' => $this->PREFIX . 'ui.systempay_rest_popin_mode.label',
            'help' => $this->PREFIX . 'ui.systempay_rest_popin_mode.helptext',
            'required' => false
        ])
        ->add(self::$ADVANCED_FIELDS . 'rest_theme', ChoiceType::class, [
            'label' => $this->PREFIX . 'ui.systempay_rest_theme.label',
            'choices' => [
                $this->PREFIX . 'config.theme.neon' => 'NEON',
                $this->PREFIX . 'config.theme.classic' => 'CLASSIC'
            ],
            'help' => $this->PREFIX . 'ui.systempay_rest_theme.helptext',
            'data' => $config[self::$ADVANCED_FIELDS . 'rest_theme'] ?? 'NEON',
            'required' => false
        ])
        ->add(self::$ADVANCED_FIELDS . 'rest_compact_mode', CheckboxType::class, [
            'label' => $this->PREFIX . 'ui.systempay_rest_compact_mode.label',
            'help' => $this->PREFIX . 'ui.systempay_rest_compact_mode.helptext',
            'required' => false
        ])
        ->add(self::$ADVANCED_FIELDS . 'rest_attempts', NumberType::class, [
            'label' => $this->PREFIX . 'ui.systempay_rest_attempts.label',
            'help' => $this->PREFIX . 'ui.systempay_rest_attempts.helptext',
            'required' => false
        ])
        ->add(self::$ADVANCED_FIELDS . 'oneclick_payment', CheckboxType::class, [
            'label' => $this->PREFIX . 'ui.systempay_oneclick_payment.label',
            'help' => $this->PREFIX . 'ui.systempay_oneclick_payment.helptext',
            'required' => false
        ])
        ->add(self::$PAYMENT_OPTIONS . 'capture_delay', NumberType::class, [
            'label' => $this->PREFIX . 'ui.systempay_capture_delay.label',
            'help' => $this->PREFIX . 'ui.systempay_capture_delay.helptext',
            'required' => false
        ])
        ->add(self::$PAYMENT_OPTIONS . 'validation_mode', ChoiceType::class, [
            'label' => $this->PREFIX . 'ui.systempay_validation_mode.label',
            'choices' => [
                $this->PREFIX . 'config.validation.backoffice' => '',
                $this->PREFIX . 'config.validation.automatic' => '0',
                $this->PREFIX . 'config.validation.manual' => '1'
            ],
            'help' => $this->PREFIX . 'ui.systempay_validation_mode.helptext',
