...
class SmartformProvider extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('systempay_get_smartform_config', [$this, 'getSmartformConfig'], ['is_safe' => ['html']]),
            new TwigFunction('systempay_get_smartform_token', [$this, 'getSmartformToken'], ['is_safe' => ['html']]),
        ];
    }
    ...
    public function getSmartformConfig($instanceCode): array
    {
        ...
        $jsClient = SystempayTools::getDefault('STATIC_URL');
