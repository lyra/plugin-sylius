...
class Tools
{
    public const FACTORY_NAME = "systempay_sylius_payment";

    private static $GATEWAY_CODE = 'Systempay';
    private static $GATEWAY_NAME = 'Systempay';
    private static $BACKOFFICE_NAME = 'Systempay';
    private static $GATEWAY_URL = 'https://paiement.systempay.fr/vads-payment/';
    ...
    private static $PLUGIN_VERSION = '2.1.2';
    private static $GATEWAY_VERSION = 'V2';
    private static $REST_URL = 'https://api.systempay.fr/api-payment/';
    private static $STATIC_URL = 'https://static.systempay.fr/static/';
    ...
    {
        return self::getDefault('CMS_IDENTIFIER') . '_' . self::getDefault('PLUGIN_VERSION') . '/' . constant('Sylius\Bundle\CoreBundle\SyliusCoreBundle::VERSION') . '/' . SystempayApi::shortPhpVersion();
    }
}