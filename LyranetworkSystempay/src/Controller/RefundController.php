...
use Lyranetwork\Systempay\Service\RefundService;
...
final class RefundController
{
    ...
    public function paymentRefundOrCancelAction(Request $request)
    {
        ...
        if ($factoryName !== constant('Lyranetwork\Systempay\Sdk\Tools::FACTORY_NAME')) {
        ...
        $currency = SystempayApi::findCurrencyByAlphaCode($payment->getCurrencyCode());
