 ...
 * for the Monetico Retail payment gateway integration.
 */
final class Tools
{
    /**
     * The payment gateway factory name used for identifying Monetico payment methods.
     */
    public const FACTORY_NAME = "monetico_sylius_payment";

    /** @var string The gateway code identifier */
    private static string $GATEWAY_CODE = 'Monetico_Retail';

    /** @var string The gateway display name */
    private static string $GATEWAY_NAME = 'Monetico Retail';

    /** @var string The merchant Back Office name */
    private static string $BACKOFFICE_NAME = 'Monetico Retail';
    ...
    private static string $SUPPORT_EMAIL = 'https://secure.gateway.monetico-retail.com/doc/fr-FR/support/index.html';

    /** @var string The current plugin version */
    private static string $PLUGIN_VERSION = '3.0.0';

    /** @var string The REST API base URL */
    private static string $REST_URL = 'https://api.gateway.monetico-retail.com/api-payment/';

    /** @var string The static resources base URL */
    private static string $STATIC_URL = 'https://static.gateway.monetico-retail.com/static/';
     ...
     *
     * @param string $translationPrefix The translation key prefix (e.g., 'sylius_monetico_plugin.')
     *
     * @return array<string, string> Array of translation keys => mode values
     */
    public static function getPaymentDataEntryModeChoices(string $translationPrefix = 'sylius_monetico_plugin.'): array
    {
        $choices = [];
     ...
     */
    public static function getThemeChoices(string $translationPrefix = 'sylius_monetico_plugin.'): array
    {
        $choices = [];
