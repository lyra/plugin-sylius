...
class RestData
{
    ...
    public function convertRestResult($answer): array
    {
        ...
        $response['vads_currency'] = MoneticoApi::getCurrencyNumCode($this->getProperty($transaction, 'currency'));
        ...
        if ($transactionDetails = $this->getProperty($transaction, 'transactionDetails')) {
            ...
            $effectiveCurrency = MoneticoApi::getCurrencyNumCode($this->getProperty($transactionDetails, 'effectiveCurrency'));
    ...
    private function prepareRequest($order)
    {
        ...
        $moneticoCurrency = MoneticoApi::findCurrencyByAlphaCode($order->getCurrencyCode());
        ...
        $data = [
            ...
            // Misc data.
            'currency' => $moneticoCurrency->getAlpha3(),
            'language' => $lang,
            'url_return' => $this->router->generate('monetico_return_url', [], UrlGenerator::ABSOLUTE_URL),
