...
class Request
{
     ...
     *
     * @var array[string][Lyranetwork\Monetico\Sdk\Form\Field]
     * @access private
     */
     ...
     *
     * @param array[string][Lyranetwork\Monetico\Sdk\Form\Field] $fields already filtered fields list
     * @param bool $hashed
     * @return string
     */
     ...
     *
     * @return array[string][Lyranetwork\Monetico\Sdk\Form\Field] a list of fields
     */
