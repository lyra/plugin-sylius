...
class Api {
     ...
     */
    public function __construct($refundProcessor, $privateKey, $restServerUrl, $siteId, $cmsName, $backOfficeName = 'Monetico Retail')
    {
    ...
    public function refund($orderInfo, $amount, $whiteLabel = '')
    {
        ...
        // Get currency.
        $currency = MoneticoApi::findCurrencyByAlphaCode($orderInfo->getOrderCurrencyIsoCode(), $whiteLabel);
