...
/**
 * Provides Twig functions for Monetico Retail embedded form integration.
 *
 * This extension exposes functions to retrieve the embedded form configuration and token
 * required for payment page rendering using Monetico Retail payment gateway.
 */
final class EmbeddedFormProvider extends AbstractExtension
{
     ...
     *
     * This method generates a payment form token from the Monetico Retail API that will be used
     ...
     * the Monetico Retail embedded form including theme, display mode, language, and API keys.
     *
     * @param string $instanceCode The payment method instance code
     *
     * @return array{
    ...
    public function getEmbeddedFormConfig(string $instanceCode): array
    {
        ...
        $theme = $activeModel != null ? $activeModel['inteConfig']['theme']['name'] : MoneticoTools::getDefault('THEME');
