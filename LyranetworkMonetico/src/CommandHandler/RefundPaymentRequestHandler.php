 ...
 * Executes refund operations through the Monetico Retail gateway and manages refund state transitions.
 */
#[AsMessageHandler]
final class RefundPaymentRequestHandler
{
     ...
     * @param RestHelper $restHelper Monetico REST operations helper
    ...
    public function __invoke(RefundPaymentRequest $refundPaymentRequest): void
    {
        ...
        $currency = MoneticoApi::findCurrencyByAlphaCode($payment->getCurrencyCode(), $whiteLabel);
    ...
    private function isValidRefundRequest(SyliusPaymentRequestInterface $paymentRequest): bool
    {
        ...
        if ($factoryName !== MoneticoTools::FACTORY_NAME) {
            return false;
        }
