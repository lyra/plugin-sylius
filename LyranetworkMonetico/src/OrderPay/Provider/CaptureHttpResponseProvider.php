...
namespace Lyranetwork\Monetico\OrderPay\Provider;
 ...
 * Renders the Monetico Retail checkout page with embedded payment form.
 */
final class CaptureHttpResponseProvider implements HttpResponseProviderInterface
{
     ...
     * Renders the Monetico Retail checkout page with payment form.
     *
     * @param RequestConfiguration $requestConfiguration The request configuration (not used)
    ...
    public function getResponse(RequestConfiguration $requestConfiguration, PaymentRequestInterface $paymentRequest): Response
    {
        ...
        return new Response(
            $this->twig->render(
                '@LyranetworkMoneticoPlugin/shop/checkout/checkout.html.twig',
                [
                    'order' => $order,
                    'method' => $method,
